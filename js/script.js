window.addEventListener('DOMContentLoaded', () => {
	...
	//сохраняем в localStorage пол и активность
	...
	// при перезагрузке страницы класс активности остается у тех элементов, которые выбрал пользователь
	...
	function getStaticInformation(selector, activeClass) {
		const elements = document.querySelectorAll(selector); // получаем все div
